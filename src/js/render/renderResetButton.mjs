export function renderResetButton() {
    ...
    container.id = 'retry';
    container.classList.add('flex-2', 'hidden', 'items-center', 'justify-center', 'size-20', 'bg-bg-dark', 'rounded-md', 'px-5');
...
export function renderSubmitButton() {
    ...
    container.classList.add('flex-1', 'flex', 'items-center', 'justify-center', 'rounded-md', 'h-20', 'font-semibold', 'text-2xl', 'bg-bg-dark');
